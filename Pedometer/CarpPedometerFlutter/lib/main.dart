...
//      const EventChannel('samples.flutter.io/eventChannel');
  ...
  Future<Null> _getBatteryLevel() async {
    String batteryLevel;
    try {
      final int result = await methodChannel.invokeMethod('getStepCount');
      batteryLevel = 'Step count from method:\n$result steps.';
...
//    setState(() {
//      _chargingStatus = "Step count from event:\n$event steps";
//    });
//  }
//
      ...
      child: new Column(
        ...
        children: <Widget>[
          new Column(
            ...
            children: <Widget>[
              new Text(_batteryLevel, key: const Key('Step Count label')),
              new Padding(
                padding: const EdgeInsets.all(16.0),
                child: new RaisedButton(
                  child: const Text('Fetch step count'),
